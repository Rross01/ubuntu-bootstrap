...
M.set = function()
    ...
    hl("CursorLine", { bg = colors.light_4 })
    ...
    hl("IncSearch", { fg = colors.dark_4, bg = colors.yellow_1 })
    ...
    hl("Search", { fg = colors.dark_4, bg = colors.yellow_1 })
    ...
    hl("Structure", { fg = colors.yellow_6 })
    ...
    hl("@constant", { fg = colors.green_6 })
    -- hl("@constant.builtin", { fg = colors.violet_4 })
    ...
    hl("@property", { fg = colors.blue_4 })
    hl("@constructor", { fg = colors.green_6 })
    ...
    -- python
    hl("@variable.member.python", { fg = colors.blue_5 })
    hl("@function.call.python", { fg = colors.green_6 })
    ...
    hl("NeoTreeFloatBorder", { fg = colors.light_5, bg = colors.light_2 })
end
