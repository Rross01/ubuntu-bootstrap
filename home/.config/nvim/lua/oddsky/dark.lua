...
M.set = function()
    vim.g.terminal_color_0 = colors.dark_7
    ...
    vim.g.terminal_color_background = colors.dark_7
    vim.g.terminal_color_foreground = colors.light_4

    -- UI highlight
    hl("Normal", { fg = colors.light_4, bg = colors.dark_7 })
    hl("NormalFloat", { fg = colors.light_4, bg = colors.dark_7 })
    hl("FloatBorder", { fg = colors.dark_4, bg = colors.dark_7 })
    hl("ColorColumn", { bg = colors.dark_5 })
    hl("Cursor", { fg = colors.dark_7, bg = colors.light_5 })
    hl("CursorLine", { bg = colors.dark_5 })
    hl("CursorColumn", { bg = colors.dark_5 })
    hl("Directory", { fg = colors.light_1, bg = colors.dark_7 })
    hl("DiffAdd", { fg = colors.teal_3, bg = colors.dark_7 })
    hl("DiffChange", { fg = colors.orange_3, bg = colors.dark_7 })
    hl("DiffDelete", { fg = colors.red_1, bg = colors.dark_7 })
    hl("DiffText", { fg = colors.violet_2, bg = colors.dark_7 })
    hl("EndOfBuffer", { fg = colors.dark_7, bg = colors.dark_7 })
    hl("ErrorMsg", { fg = colors.red_3, bg = colors.dark_7, underline = true })
    hl("VertSplit", { fg = colors.dark_4, bg = colors.dark_7 })
    hl("WinSeparator", { link = "VertSplit" })
    hl("Folded", { fg = colors.dark_1, bg = colors.dark_7 })
    hl("FoldColumn", { fg = colors.dark_1, bg = colors.dark_7 })
    hl("SignColumn", { fg = colors.dark_2, bg = colors.dark_7 })
    hl("IncSearch", { fg = colors.dark_4, bg = colors.yellow_4 })
    hl("LineNr", { fg = colors.dark_2, bg = colors.dark_7 })
    hl("CursorLineNr", { fg = colors.light_7, bg = colors.dark_5 })
    hl("MatchParen", { fg = colors.light_4, bold = true })
    hl("ModeMsg", { fg = colors.light_4, bg = colors.dark_5 })
    hl("MoreMsg", { fg = colors.light_4, bg = colors.dark_5 })
    hl("NonText", { fg = colors.dark_4 })
    hl("Pmenu", { fg = colors.light_4, bg = colors.dark_7 })
    hl("PmenuSel", { fg = colors.light_4, bg = colors.dark_5 })
    hl("PmenuSbar", { bg = colors.dark_3 })
    hl("PmenuThumb", { bg = colors.dark_1 })
    hl("Question", { fg = colors.blue_1, bg = colors.dark_7 })
    hl("Search", { fg = colors.dark_4, bg = colors.yellow_4 })
    hl("SpecialKey", { fg = colors.dark_2, bg = colors.dark_7 })
    hl("StatusLine", { fg = colors.light_4, bg = colors.dark_5 })
    hl("StatusLineNC", { fg = colors.light_4, bg = colors.dark_7 })
    hl("Tabline", { fg = colors.light_4, bg = colors.dark_5 })
    hl("TablineFill", { fg = colors.light_4, bg = colors.dark_5 })
    hl("TablineSel", { fg = colors.light_4, bg = colors.dark_7 })
    hl("Title", { bold = true })
    ...
    hl("CmpNDocBorder", { fg = colors.dark_4, bg = colors.dark_7 })
    ...
    hl("BufferLineIndicatorSelected", { bg = colors.dark_7 })
    hl("BufferLineFill", { bg = colors.dark_5 })
    ...
    -- neotree
    hl("NeoTreeDirectoryName", { fg = colors.light_4 })
    hl("NeoTreeDirectoryIcon", { fg = colors.light_4 })
    hl("NeoTreeFloatBorder", { fg = colors.dark_3, bg = colors.dark_7 })
end
